...
function Tablet_Section2() {
    return (
        <section className='relative w-full h-auto flex justify-center'>
            <div className='relative font-roboto items-center text-start w-[1000px] mt-8 ml-20 mr-20 pb-8'>
                <div className='text-custom-navy font-semibold text-3xl tracking-widest border-b-2 border-custom-blue pb-3 mt-8 mb-8'>
                    {introduction.title}
                </div>
                <div className='text-custom-gray text-base tracking-tight leading-8 mb-2'>
