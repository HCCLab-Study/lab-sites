			...
			<div className="absolute h-[350px] w-full left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2 font-roboto text-start flex items-center">
				<div className="flex w-full">
					...
					<div className="relative">
						<div
							className="text-5xl font-semibold tracking-tight text-custom-navy"
							style={{ marginTop: '50px', marginBottom: '50px' }}>
							We develop technology for people
						</div>
						<div className="mt-3 text-xl font-medium leading-6 tracking-tight text-custom-gray">
							인간중심컴퓨팅연구실 (HCC Lab)은 사람을 더 잘 이해하는 방법을 탐구하는 동시에, 사용자를 널리 이롭게 하는
							소프트웨어 개발과 인공지능 기술을 연구합니다.
						</div>
						<div className="mt-3 text-xl font-medium leading-6 tracking-tight text-custom-gray">
							세상에 실존하는 문제의 해결 과정은 늘 복잡하고 여러 분야의 지식이 얽혀있습니다.
						</div>
						<div className="mt-3 text-xl font-medium leading-6 tracking-tight text-custom-gray">
							HCC Lab은 사용자경험(UX)을 핵심가치로 삼아 기획, 분석, 개발의 영역을 다루고 있으며, 특히 여러 영역의
							경계에서 도전적인 문제를 해결하고 있습니다.
						</div>
						<div className="mt-3 text-xl font-medium leading-6 tracking-tight text-custom-gray">
						...
						<div
							className="absolute justify-start p-3 px-8 text-lg font-semibold text-white rounded-full font-roboto bg-custom-blue"
