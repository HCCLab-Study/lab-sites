...
function Section3({ finishedProjects }: { finishedProjects: Project[] }) {
  ...
  const sectionHeight = `${finishedProjects.length * 30}px`;   // 섹션의 높이를 project 개수에 맞게 동적으로 조절하기 위함

  return (
    <section className='relative w-full	h-[1000px] left-0 right-0 bg-section-gray'>
