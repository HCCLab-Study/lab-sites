...
import DeskTop_Section3 from './section3/desktop_section3';
import Mobile_Section3 from './section3/mobile_section3';
import Tablet_Section3 from './section3/tablet_section3';
